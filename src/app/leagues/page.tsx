...
export default function LeaguesPage() {
  ...
  async function joinLeague() {
    ...
    if (!league) {
      setError('Liga no encontrada. Verifica el código.')
      return
    }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 flex items-center justify-center">
        <div className="text-white text-xl">Cargando ligas...</div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900">
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-6">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="bg-green-500 text-white font-semibold px-6 py-2 rounded-lg hover:bg-green-400"
              >
                Crear
              </button>
              <button
        ...
        {showJoin && (
          <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-6">
            <h2 className="text-xl font-semibold text-white mb-4">Unirse a una Liga</h2>
            <input
              type="text"
        ...
        {leagues.length === 0 ? (
          <div className="bg-white/10 backdrop-blur rounded-xl p-8 text-center">
            <p className="text-green-200 text-lg">No estás en ninguna liga aún</p>
            <p className="text-green-200/70 mt-2">
              Crea una liga e invita a tus amigos, o únete con un código.
            </p>
          </div>
        ) : (
